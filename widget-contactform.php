...
<section class="c-contact">
    ...
    <div class="c-contact__form">
        <script type="text/javascript" src="//my.reiblackbook.com/forms/web-form-165048.js"></script><script>
        window.onload=function(){
        var message = {
            "loc":window.location.href,
            "type":"framedForm"
        };
        document.getElementById("form_iframe_165048").contentWindow.postMessage(JSON.stringify(message),"*");
        };
        </script>
    </div>
